...
from oaf_vision_3d.s2m2_implementation.model.utils import get_pe
...
class Unet(nn.Module):
    ...
    def __init__(
        ...
        self.concat_conv0 = FeatureFusion(
            dims[0], kernel_size=1, use_gate=use_gate_fusion
        )
        self.concat_conv1 = FeatureFusion(
            dims[1], kernel_size=1, use_gate=use_gate_fusion
        )
        self.concat_conv2 = FeatureFusion(
